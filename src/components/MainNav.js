...
export default function MainNav(props){
    return(
        <section className="mainNav" style={{display:props.display}}>
            <Link to="/albums">
                <img src="../Pulse.svg" alt="Icon of pulse" style={{filter:props.filterPulse}}/>
            </Link>
            <Link to="/playlists">
            ...
            <Link to="/colortheme">
                <img src="../Contrast.svg" alt="Icon for light and dark mode"  style={{filter:props.filterContrast}}/>
            </Link>
            <Link to="/categories">
                <img src="../Sett.svg" alt="Icon for settings"  style={{filter:props.filterSett}}/>
            </Link>
        </section>
    )
}